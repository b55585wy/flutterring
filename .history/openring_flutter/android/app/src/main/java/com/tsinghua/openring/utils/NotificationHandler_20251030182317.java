...
// PlotView removed - Flutter handles UI rendering
...
public class NotificationHandler {
    ...
    // PlotViews removed - Flutter handles real-time data display
    ...
    // PlotView setting methods - REMOVED for Flutter
    // Flutter will handle all UI rendering through the event stream
    ...
    private static void updateRealtimeCharts(long green, long red, long ir,
        ...
        try {
            // PlotView chart updates removed - Flutter handles UI rendering
            // Data is still processed and sent via callbacks
    ...
    public static void clearAllCharts() {
        try {
            // PlotView clearing removed - Flutter handles UI state
            ...
            Log.d(TAG, "All charts cleared (Flutter mode - no-op)");
        } catch (Exception e) {
     ...
     * Flutter mode: always return false as charts are handled by Flutter
     */
    public static boolean hasValidCharts() {
        return false; // Flutter handles all charts
