...
import 'package:openring_flutter/domain/models/sample.dart' show SignalQuality;
...
class _MeasurementPageState extends ConsumerState<MeasurementPage>
  ...
  Widget _buildSignalQualityBar(SignalQuality? quality) {
    final qualityLevel = quality == SignalQuality.excellent
        ? 1.0
    ...
    final qualityColor = quality == SignalQuality.excellent
        ? const Color(0xFF10B981)
        : quality == SignalQuality.good
            ? const Color(0xFF3B82F6)
            : quality == SignalQuality.fair
